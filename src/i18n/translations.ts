export const translations = {
  ar: {
    ...
    footer: {
      ...
      support: "مركز الدعم",
      desc: "دوما — وجهة الشراكات التطويرية التي تعيد تعريف استثمار الأراضي وتحويلها إلى أصول منتجة",
    },
  ...
  en: {
    ...
    footer: {
      ...
      desc: "DOMA — the destination for development partnerships that redefine land investment and transform it into productive assets",
    },
