...
const PrivacyPage: React.FC = () => {
  ...
  const sections = isAr ? [
    ...
    { title: "2. استخدام البيانات", text: "تُستخدم بياناتك لتشغيل المنصة وتقديم الخدمات المطلوبة، مثل مطابقة الملاك بالمطورين وإدارة الصفقات وإرسال التنبيهات ذات الصلة." },
    ...
    { title: "6. التحديثات", text: "قد نحدّث هذه السياسة من وقت لآخر. سيتم إشعارك بأي تغييرات جوهرية عبر البريد الإلكتروني أو إشعارات المنصة." },
  ] : [
  ...
  return (
    <PageShell>
      <InnerHero pageSlug="privacy" title={isAr ? "سياسة الخصوصية" : "Privacy Policy"} subtitle={isAr ? "كيف نحمي بياناتك ونستخدمها" : "How we protect and use your data"} isAr={isAr} image={headerPrivacyImg} />
