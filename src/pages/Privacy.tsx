...
const PrivacyPage: React.FC = () => {
  ...
  return (
    <PageShell>
      <InnerHero title={isAr ? "سياسة الخصوصية" : "Privacy Policy"} subtitle={isAr ? "كيف نحمي بياناتك ونستخدمها" : "How we protect and use your data"} isAr={isAr} image={headerPrivacyImg} />
