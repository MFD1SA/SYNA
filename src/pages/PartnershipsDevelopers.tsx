...
const PartnershipsDevelopers: React.FC = () => {
  ...
  const devFeatures = isAr
    ? [
        { icon: MapPin, title: "فرص تطويرية حقيقية ومتجددة", desc: "أراضٍ حقيقية من ملاك تم التحقق منهم متاحة للشراكة مع بيانات تفصيلية كافية لاتخاذ قرار استثماري مدروس دون الحاجة للبحث التقليدي المكلف والمستهلك للوقت" },
        ...
        { icon: BadgeCheck, title: "بناء سمعة مهنية قوية ومتنامية", desc: "كل مشروع ناجح تنفذه يُسجّل في ملفك على المنصة ويرفع تصنيفك المهني ويجذب لك فرص شراكة أفضل مع ملاك أراضٍ أكثر وأراضٍ أكبر" },
      ]
    : [
  ...
  const devAdvantages = isAr
    ? [
        ...
        { icon: Network, title: "وصول مباشر للفرص", desc: "لا تضيع وقتك في البحث التقليدي عن أراضٍ مناسبة بل تصفّح فرصاً حقيقية متاحة من ملاك يبحثون عن مطورين" },
  ...
  return (
    <PageShell>
      <InnerHero
        ...
        subtitle={isAr
          ? "نفّذ مشاريع أكثر بتكلفة أقل مع وصول مباشر لأراضٍ مؤهلة وملاك يبحثون عن مطورين موثوقين عبر منصة سينا"
