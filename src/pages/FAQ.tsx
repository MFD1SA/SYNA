...
const faqData = [
  ...
  { qAr: "ما الفرق بين شراكة التطوير والمساهمة العقارية؟", qEn: "What's the difference between a development partnership and a real estate contribution?", aAr: "شراكة التطوير: يتفق المالك والمطور على تطوير الأرض معاً وفق نموذج ربحي. المساهمة العقارية: يساهم المالك بالأرض مع مطور مرخص رسمياً بالمساهمات العقارية ويتم التخارج بنسبة محددة.", aEn: "Development Partnership: Owner and developer agree to develop land together under a profit model. Real Estate Contribution: Owner contributes land with a developer officially licensed for real estate contributions, exiting at a predetermined percentage." },
