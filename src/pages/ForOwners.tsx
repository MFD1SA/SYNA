          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {values.map((v, i) => (
              <div key={i} className="bg-white rounded-xl p-7 border border-gray-100 hover:shadow-lg transition-all duration-300">
                <v.icon className="w-6 h-6 text-[#2B2B2B] mb-5" strokeWidth={1.5} />
      ...
      <section className="py-14 lg:py-16 bg-white border-t border-gray-100" dir={isAr ? "rtl" : "ltr"}>
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
            {steps.map((step, i) => (
              <div key={i} className="bg-white rounded-xl p-7 border border-gray-100 hover:shadow-lg transition-all duration-300">
                <span className="text-[13px] font-bold text-[#2B2B2B] mb-4 block">{step.num}</span>
          ...
          <div className="text-center mt-14">
            <button onClick={() => navigate("/auth/login?type=owner")} className="inline-flex items-center gap-3 h-14 px-12 bg-[#2B2B2B] text-white text-[15px] font-semibold rounded-xl hover:bg-[#020202] shadow-lg shadow-[#2B2B2B]/20 transition-all duration-300">
              {t.forOwners.cta}
