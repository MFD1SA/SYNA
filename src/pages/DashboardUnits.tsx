...
const emptyForm = {
  project_id: "",
  unit_type: "shop" as "showroom" | "shop" | "office" | "apartment",
  area_sqm: "",
  listing_price: "",
...
const UnitsPage: React.FC = () => {
  ...
  const handleEdit = (u: Unit) => {
    ...
    setForm({
      ...
      listing_price: u.listing_price?.toString() ?? "",
  ...
  return (
    <DashboardLayout>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-medium text-foreground">{isAr ? "الوحدات" : "Units"}</h1>
              ...
              {units.map((u) => (
                <TableRow key={u.id}>
                  ...
                  <TableCell className="font-light">
                    {isAr ? unitTypeLabels[u.unit_type]?.ar : unitTypeLabels[u.unit_type]?.en}
                  </TableCell>
