...
const articles: BlogArticle[] = [
  ...
  },
  {
    ...
    contentAr: [
      ...
      "السبب السابع هو الأمان القانوني: من خلال سينا للاستثمارات العقارية جميع الشراكات موثقة بعقود واضحة تحمي حقوقك بالكامل وكل مرحلة مسجلة ومتابعة إلكترونياً مما يوفر لك طمأنينة كاملة",
    ],
    contentEn: [
  ...
  },
  {
    ...
    contentAr: [
      ...
      "الشراكة التطويرية أيضاً تسرّع دورة المشروع فبدلاً من قضاء أشهر في البحث عن أرض مناسبة والتفاوض على سعرها سينا للاستثمارات العقارية توفر فرصاً جاهزة ومؤهلة مع ملاك مستعدين للشراكة وهذا يختصر مرحلة ما قبل التطوير بشكل كبير",
  ...
  },
  {
    ...
    summaryAr: "تعرّف على آليات الحماية والحوكمة التي توفرها سينا للاستثمارات العقارية لضمان نجاح الشراكات وحماية حقوق الملاك والمطورين بشكل كامل",
    ...
    contentAr: [
      ...
      "أولاً التحقق من الهوية والمؤهلات: كل مطور عقاري يسجل في سينا يمر بعملية تحقق شاملة تتضمن السجل التجاري والتراخيص المطلوبة وسجل المشاريع السابقة وهذا يضمن أن المالك يتعامل فقط مع مطورين مؤهلين وموثوقين",
      ...
      "ثالثاً التوثيق الكامل: كل خطوة في عملية الشراكة من أول طلب حتى إغلاق الصفقة موثقة إلكترونياً داخل سينا وهذا يوفر سجلاً كاملاً يمكن الرجوع إليه في أي وقت ويحمي حقوق الطرفين قانونياً",
      "رابعاً المتابعة المستمرة: سينا توفر لوحة تحكم متكاملة لمتابعة جميع مراحل المشروع من مرحلة التفاوض والاتفاق وحتى التنفيذ والتسليم وأي تأخير أو تغيير في الجدول يُسجل ويُبلغ عنه تلقائياً",
    ],
    contentEn: [
  ...
  },
  {
    ...
    contentAr: [
      ...
      "سينا تؤمن بأن تنظيم سوق الشراكات التطويرية هو خطوة أساسية نحو قطاع عقاري أكثر نضجاً وشفافية ومن خلال شركة رقمية تجمع الملاك والمطورين وتنظم العلاقة بينهم نساهم في بناء منظومة عقارية تتوافق مع تطلعات المملكة ورؤيتها المستقبلية",
    ],
    contentEn: [
      ...
      <section className="py-16 lg:py-20 bg-[#020202]" dir={isAr ? "rtl" : "ltr"}>
        <div className="container text-center">
          ...
          <p className="text-[15px] text-white/50 mb-10 max-w-xl mx-auto">
            {isAr
              ? "انضم لسينا للاستثمارات العقارية وابدأ رحلتك نحو شراكات تطويرية ناجحة ومربحة لجميع الأطراف"
