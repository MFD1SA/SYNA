  ...
  return (
    <div className="max-w-2xl mx-auto bg-white text-foreground p-8 rounded-xl border border-border print:border-0 print:shadow-none" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="text-center mb-6">
        <img src="/favicon.png" alt="SYNA" className="mx-auto h-12 w-12 mb-3" />
        <h1 className="text-lg font-semibold">
          {isAr ? "وثيقة الإقرار القانوني" : "Legal Acknowledgment Document"}
        </h1>
        <p className="text-xs text-muted-foreground mt-1">SYNA Platform — {isAr ? "منصة سينا للتطوير العقاري" : "Real Estate Development Platform"}</p>
        {referenceNumber && (
      ...
      <div className="text-center text-[10px] text-muted-foreground mt-6">
        <p>SYNA Platform v1.0.0 — {isAr ? "شركة دوما للتقنية" : "DOMA Technology Company"}</p>
