...
const serviceItems: { titleAr: string; titleEn: string; icon: typeof Eye; descAr: string; descEn: string }[] = [
  ...
  { 
    ...
    icon: Handshake, 
    descAr: "ربط ملاك الأراضي بالمطورين العقاريين المؤهلين والمستثمرين الاستراتيجيين في بيئة آمنة وموثوقة.",
    descEn: "Connecting landowners with qualified developers and strategic investors in a secure and reliable environment."
  },
  { 
...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section id="services" className="relative bg-background py-32 px-4 md:px-0 overflow-hidden">
      {/* Background Element */}
