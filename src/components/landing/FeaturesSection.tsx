      ...
      <div className="container relative">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map(({ key, icon: Icon }, idx) => (
            <div
              key={key}
              className="group relative overflow-hidden doma-card p-5"
            >
              ...
              <div className="relative">
                <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 transition-all duration-200 group-hover:from-primary/15 group-hover:to-primary/8">
