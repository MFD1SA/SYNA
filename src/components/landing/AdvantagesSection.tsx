    ...
    <section className="py-14 lg:py-16 bg-white" dir={isAr ? "rtl" : "ltr"}>
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#020202] mb-4 tracking-tight">
            {t.advantages.title}
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map((item, i) => (
            <div
              key={i}
              className="bg-white rounded-xl p-7 border border-gray-100 border-s-2 border-s-[#2B2B2B]/80 hover:shadow-lg hover:shadow-gray-100/60 transition-all duration-300 group"
            >
              <div className="flex items-start gap-4">
                <item.icon className="w-5 h-5 text-[#2B2B2B] mt-0.5 flex-shrink-0" strokeWidth={1.5} />
                <div className="min-w-0">
                  <h3 className="text-[15px] font-semibold text-[#020202] mb-2">
                    {item.title}
                  </h3>
